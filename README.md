*This project has been created as part of the 42 curriculum by **palenki**.*
...
- Manipulating strings (like counting the length of a text).
- Managing memory.

## Instructions
The project is currently under development. In the future, it will be compiled using a `Makefile`.
